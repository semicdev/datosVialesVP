...
<div class="container">
	<?php
		echo "<h1><a href='carreteras.php?tiempo=".$tiempo."&estado=".$estado."'>Regresar</a></h1><br>";
	?>
</div>
...
<script type="text/javascript"> 
	...
	function initialize()
	{
		downloadUrl("gm_web_carretera_proc_v1.php?tiempo=" + <?php echo("\"".$tiempo."\""); ?> + "&estado=" + <?php echo("\"".$estado."\""); ?>  + "&carretera=" + <?php echo("\"".$carretera."\""); ?>  , function(data) 
		{
